...
The `Inspector` requires the nucleosome profiles generated by the `Profiler`.
   * `Inspector` workflow:
   <ol>
        <li>Quantile normalisation of nucleosome profiles by [danpos wiq](https://sites.google.com/site/danposdoc/b-documentation/7-wiq)</li>
        <li>Generating a TSS plot using [deepTools](https://github.com/deeptools/deepTools/tree/master) `computeMatrix` and `plotProfile`</li>
        <li>Peak scoring by [deepTools](https://github.com/deeptools/deepTools/tree/master) `multiBigwigSummary`</li>
        <li>Correlation plot by [deepTools](https://github.com/deeptools/deepTools/tree/master) `plotCorrelation`</li>
        <li>PCA plot by [deepTools](https://github.com/deeptools/deepTools/tree/master) `plotPCA`</li>
        <li>Analysis of nucleosome occuancy</li>
        <li>Defining regions of low regularity between samples</li>
        <li>Define nucleosome shifts between samples</li>
        <li>Define fuzzy nucleosomes</li>
